...
État : **chaîne créée** , [https://www.youtube.com/@KaiDO-learning](https://www.youtube.com/@KaiDO-learning). Visuels prêts à téléverser, aucune vidéo en ligne. Les deux vidéos restent auto-hébergées sur [https://alogean.github.io/kaido/videos/](https://alogean.github.io/kaido/videos/).
...
**Handle : tranché.** `@KaiDO-learning`, choisi en remplacement du `@KaiDO-m2` attribué d'office à la création. Le lien canonique à diffuser partout est <https://www.youtube.com/@KaiDO-learning>.
...
| Handle                                  | `@KaiDO-learning` (choisi)                          | Remplace le `@KaiDO-m2` attribué d'office à la création.                                                                                                            |
...
2. ~~Nom `KaiDO`, handle~~ **fait.** Handle définitif : `@KaiDO-learning`.
